...
import ActionClasses.TransferServiceOut;
import ActionsBaseClasses.CommonTestSteps;
import ServiceNow.Approvals;
import ServiceNow.BaseClass;

public class TC0044TransferServiceOutAndApprove extends BaseClass 
{
	...
	@Test
	public static void tc0044TransferServiceOutAndApprove() throws Exception
	{
		...
		approvalActionType = ApprovalActionType.transferServiceOut;
		...
		TransferServiceOut.RunTransferServiceOut();
		
		CommonTestSteps.Logout();
		
		BaseClass.stepComplete("Run transfer service out action complete. Now will approve the order.", "");
		...
		// this finds the approval entry for the Transfer Service Out order just placed by the limited user, approves it, and 
		...
		TransferServiceOut.VerifyLimitedUserOrderMyOrdersMainPage();
		...
		BaseClass.stepComplete("Transfer Service Out Test Complete.", "");	
	}
