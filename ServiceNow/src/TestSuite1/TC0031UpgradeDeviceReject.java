...
public class TC0031UpgradeDeviceReject extends BaseClass 
{
	...
	@Test
	public static void tc0031UpgradeDeviceReject() throws Exception
	{
		BaseClass.stepComplete("------------------ Starting upgrade device action with reject. -----------------------", "");
		...
		BaseClass.stepComplete("Run upgrade device action complete. Now will reject the order.", "");
