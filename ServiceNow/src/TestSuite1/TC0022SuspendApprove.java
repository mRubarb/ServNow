...
public class TC0022SuspendApprove extends BaseClass
{
	...
	@Test
	public static void tc0022SuspendApprove() throws Exception
	{
		BaseClass.stepComplete("------------------ Starting suspend action with approve. -----------------------", "");
		...
		// this finds the approval entry for the Suspend order just placed by the limited user, approves it, and 
