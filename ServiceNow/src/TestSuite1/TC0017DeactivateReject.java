...
public class TC0017DeactivateReject extends BaseClass 
{
	...
	@Test
	public static void tc0017DeactivateReject() throws Exception
	{
		BaseClass.stepComplete("------------------ Starting deactivate action with reject. -----------------------", "");
