...
public class TC0045TransferServiceOutAndReject extends BaseClass
{
	@BeforeClass
	...
	@Test
	public static void tc0044TransferServiceOutAndReject() throws Exception
	{
		...
		// this finds the approval entry for the Transfer Service Out order just placed by the limited user, rejects it, and 
