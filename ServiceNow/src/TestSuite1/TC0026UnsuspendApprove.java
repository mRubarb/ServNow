...
public class TC0026UnsuspendApprove extends BaseClass 
{
	...
	@Test
	public static void tc0026UnsuspendApprove() throws Exception
	{
		BaseClass.stepComplete("------------------ Starting unsuspend action with approve. -----------------------", "");		
		...
		BaseClass.stepComplete("Run unsuspend action complete. Now will approve the order.", "");
